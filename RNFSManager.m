                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSError *error = nil;
  BOOL success = [fileManager createDirectoryAtPath:filepath withIntermediateDirectories:YES attributes:attributes error:&error];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSData *content = [fileManager contentsAtPath:filepath];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSError *error = nil;
  BOOL success = [fileManager moveItemAtPath:filepath toPath:destPath error:&error];
  ...
  if ([options objectForKey:@"NSFileProtectionKey"]) {
    NSMutableDictionary *attributes = [NSMutableDictionary new];
    [attributes setValue:[options objectForKey:@"NSFileProtectionKey"] forKey:@"NSFileProtectionKey"];
    BOOL updateSuccess = [fileManager setAttributes:attributes ofItemAtPath:destPath error:&error];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSError *error = nil;
  BOOL success = [fileManager copyItemAtPath:filepath toPath:destPath error:&error];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  if (!self.downloaders) self.downloaders = [NSMutableDictionary new];
  ...
  if (uuid) {
    if (!self.uuids) self.uuids = [NSMutableDictionary new];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  if (!self.uploaders) self.uploaders = [NSMutableDictionary new];
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
  ...
  NSError *error = nil;
  BOOL success = [fileManager setAttributes:attr ofItemAtPath:filepath error:&error];
...
{
  if (!completionHandlers) completionHandlers = [NSMutableDictionary new];
