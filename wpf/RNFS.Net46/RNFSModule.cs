...
namespace RNFS
{
    public class RNFSModule : ReactContextNativeModuleBase
    {
        ...
        public RNFSModule(ReactContext reactContext)
            : base(reactContext)
        {
        }
        ...
        public override IReadOnlyDictionary<string, object> Constants
        {
            get
            {
                ...
                {
                    { "RNFSMainBundlePath", System.AppDomain.CurrentDomain.BaseDirectory },
                    { "RNFSCachesDirectoryPath", Environment.GetFolderPath(Environment.SpecialFolder.InternetCache) },
                    { "RNFSRoamingDirectoryPath", Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) },
                    { "RNFSDocumentDirectoryPath", Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) },
                    { "RNFSTemporaryDirectoryPath", System.IO.Path.GetTempPath() },
        ...
        [ReactMethod]
        public  void getFSInfo(IPromise promise)
        {
